//*************************************
// book2(RT in 1 week) ch05
// 相较于原书 添加如下功能：
// *(ch01&05) 修复了结果中大球体不会反射运动模糊的 bug, in material.h
...
// scene book1 final & solid textrue
hittable* random_scene()
{
	...
	list[i++] = new sphere(vec3(-4.0f, 1.0f, 0.0f), 1.0f, new lambertian(new constant_texture(vec3(0.5f, 0.5f, 0.5f))));
...
int main() {
	...
	// 写出png图片
	stbi_write_png("book2-ch05.png", nx, ny, channels, data, 0);
